...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->lbl_controleEstoque->Location = System::Drawing::Point(11, 46);
			this->lbl_controleEstoque->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->lbl_controleEstoque->Name = L"lbl_controleEstoque";
			this->lbl_controleEstoque->Size = System::Drawing::Size(199, 29);
			...
			this->dataGrid_estoque->Location = System::Drawing::Point(11, 102);
			this->dataGrid_estoque->Margin = System::Windows::Forms::Padding(2);
			...
			// btn_aumentarEstoque
			// 
			this->btn_aumentarEstoque->Location = System::Drawing::Point(11, 378);
			this->btn_aumentarEstoque->Margin = System::Windows::Forms::Padding(2);
			this->btn_aumentarEstoque->Name = L"btn_aumentarEstoque";
			this->btn_aumentarEstoque->Size = System::Drawing::Size(70, 45);
			this->btn_aumentarEstoque->TabIndex = 11;
			this->btn_aumentarEstoque->Text = L"Aumentar Estoque";
			...
			// btn_diminuirEstoque
			// 
			this->btn_diminuirEstoque->Location = System::Drawing::Point(86, 378);
			this->btn_diminuirEstoque->Margin = System::Windows::Forms::Padding(2);
			this->btn_diminuirEstoque->Name = L"btn_diminuirEstoque";
			this->btn_diminuirEstoque->Size = System::Drawing::Size(70, 45);
			this->btn_diminuirEstoque->TabIndex = 12;
			this->btn_diminuirEstoque->Text = L"Diminuir Estoque";
			...
			// 
			this->btn_adicionarProduto->Location = System::Drawing::Point(432, 378);
			this->btn_adicionarProduto->Margin = System::Windows::Forms::Padding(2);
			this->btn_adicionarProduto->Name = L"btn_adicionarProduto";
			this->btn_adicionarProduto->Size = System::Drawing::Size(75, 45);
			this->btn_adicionarProduto->TabIndex = 13;
			this->btn_adicionarProduto->Text = L"Adicionar Produto";
			...
			// btn_Editar
			// 
			this->btn_Editar->Location = System::Drawing::Point(511, 378);
			this->btn_Editar->Margin = System::Windows::Forms::Padding(2);
			this->btn_Editar->Name = L"btn_Editar";
			this->btn_Editar->Size = System::Drawing::Size(75, 45);
			...
			this->ClientSize = System::Drawing::Size(608, 461);
	...
	private: System::Void btn_Editar_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		for (;aux != nullptr;aux = aux->eloF) {
			if (aux->info.codigo == codigoProdutoSelecionado) {
				...
				if (this->txt_preco->Text != "0" && this->txt_preco->Text != "") {
					novoProduto.preco = Int32::Parse(this->txt_preco->Text);
					aux->info.preco = novoProduto.preco;
				}
				if (this->txt_estoque->Text != "0" && this->txt_estoque->Text != "") {
					novoProduto.estoque = Int32::Parse(this->txt_estoque->Text);
